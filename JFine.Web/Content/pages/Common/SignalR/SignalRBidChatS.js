...
$(function () {
    ...
    chat.client.receiveManagerMessage = function (account, name, message) {
    ...
    $.connection.hub.start().done(function () {
        ...
        chat.server.connect(projectNo, useraccount, username, "1", IP);
        ...
        function send() {
            ...
            console.log(tousers);
            chat.server.sendMessage(projectNo, "1", useraccount, tousers, touserNames, $("#clientMessage").val(), "竞价");

            var nowStr = getNowFormatDate();
            $("#chat-content_2").append(
                       " <li class=\"jfine-chat-mine\"><div class=\"jfine-chat-user\"><img src=\"/Content/img/headImage/"
                       + useraccount + ".png\" onerror=\"$.noFindHeadImage(this);\"><cite>"
                       + htmlEncode(username) + "<i>" + nowStr + "</i></div>"
