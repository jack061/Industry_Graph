...
{	
	...
	/// IOTMouldTParaBLL
	/// </summary>	
	public class IOTMouldTParaBLL
	{
	    private IIOTMouldTParaRepository service=new IOTMouldTParaRepository();

		/// <summary>
        /// 缓存key
        /// </summary>
        public string cacheKey ="IOTMouldTParaCache" ;
        ...
        /// <returns></returns>
        public IEnumerable<IOTMouldTParaEntity> GetPageListBySql(Pagination pagination, string queryJson)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public IEnumerable<IOTMouldTParaEntity> GetList( string queryJson)
        {
             var expression = LinqExtensions.True<IOTMouldTParaEntity>();
            var queryParam = queryJson.ToJObject();
            //查询条件
        ...
        /// <param name="queryJson">查询参数</param>
        /// <returns></returns>
        public IEnumerable<IOTMouldTParaEntity> GetPageList(Pagination pagination, string queryJson, string bindid)
        {
			var expression = LinqExtensions.True<IOTMouldTParaEntity>();
            var queryParam = queryJson.ToJObject();
             //查询条件
        ...
        public void SaveForm(string keyValue, IOTMouldTParaEntity iOTMouldTParaEntity)
        {
            try
            {
                service.SaveForm(keyValue, iOTMouldTParaEntity);
                CacheFactory.Cache().WriteCache(cacheKey,iOTMouldTParaEntity);
            }
            catch (Exception)
            {
                throw;
