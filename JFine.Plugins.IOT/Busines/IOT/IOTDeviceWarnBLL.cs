...
{	
	...
	/// IOTDeviceWarnBLL
	/// </summary>	
	public class IOTDeviceWarnBLL
	{
	    private IIOTDeviceWarnRepository service=new IOTDeviceWarnRepository();

		/// <summary>
        /// 缓存key
        /// </summary>
        public string cacheKey ="IOTDeviceWarnCache" ;
        ...
        /// <returns></returns>
        public IEnumerable<IOTDeviceWarnEntity> GetPageListBySql(Pagination pagination, string queryJson)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public IEnumerable<IOTDeviceWarnEntity> GetList( string queryJson)
        {
             var expression = LinqExtensions.True<IOTDeviceWarnEntity>();
            var queryParam = queryJson.ToJObject();
            //查询条件
        ...
        /// <param name="queryJson">查询参数</param>
        /// <returns></returns>
        public IEnumerable<IOTDeviceWarnEntity> GetPageList(Pagination pagination, string queryJson)
        {
			var expression = LinqExtensions.True<IOTDeviceWarnEntity>();
            var queryParam = queryJson.ToJObject();
             //查询条件
        ...
        public void SaveForm(string keyValue, IOTDeviceWarnEntity iOTDeviceWarnEntity)
        {
            try
            {
                service.SaveForm(keyValue, iOTDeviceWarnEntity);
                CacheFactory.Cache().WriteCache(cacheKey,iOTDeviceWarnEntity);
            }
            catch (Exception)
            {
                throw;
        ...
        public void DealWithWarn(string keyValue, IOTDeviceWarnEntity iOTDeviceWarnEntity)
        {
            try
            {
                service.DealWithWarn(keyValue, iOTDeviceWarnEntity);
            }
            catch (Exception)
            {
                throw;
