...
{	
	...
	/// IOTDeviceWarnEntity
	/// </summary>	
	public class IOTDeviceWarnEntity:BaseEntity<IOTDeviceWarnEntity>, ICreate, IModify
	{

		/// <summary>
        /// 默认构造函数
        /// </summary>
        public IOTDeviceWarnEntity()
		{
