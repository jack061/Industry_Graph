...
<AgentID>2</AgentID>
            ...
            //记录上下文
            if (RequestMessage.MsgType != RequestMsgType.DEFAULT && MessageContextGlobalConfig.UseWeixinContext)
            {
        ...
        public override void Execute()
        {
            ...
            try
            {
                ...
                //记录上下文
                if (MessageContextGlobalConfig.UseWeixinContext && ResponseMessage != null)
                {
