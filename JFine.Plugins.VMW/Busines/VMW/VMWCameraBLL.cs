...
{	
	...
	/// VMWCameraBLL
	/// </summary>	
	public class VMWCameraBLL
	{
	    private IVMWCameraRepository service=new VMWCameraRepository();

		/// <summary>
        /// 缓存key
        /// </summary>
        public string cacheKey ="VMWCameraCache" ;
        ...
        /// <returns></returns>
        public IEnumerable<VMWCameraEntity> GetPageListBySql(Pagination pagination, string queryJson)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public IEnumerable<VMWCameraEntity> GetList( string queryJson)
        {
             var expression = LinqExtensions.True<VMWCameraEntity>();
            var queryParam = queryJson.ToJObject();
            //查询条件
        ...
        /// <param name="queryJson">查询参数</param>
        /// <returns></returns>
        public IEnumerable<VMWCameraEntity> GetPageList(Pagination pagination, string queryJson)
        {
			var expression = LinqExtensions.True<VMWCameraEntity>();
            var queryParam = queryJson.ToJObject();
             //查询条件
        ...
        {
            return service.GetForm(code,key);
        }
        ...
        public void SaveForm(string keyValue, VMWCameraEntity vMWCameraEntity)
        {
            try
            {
                service.SaveForm(keyValue, vMWCameraEntity);
                CacheFactory.Cache().WriteCache(cacheKey,vMWCameraEntity);
            }
            catch (Exception)
            {
                throw;
