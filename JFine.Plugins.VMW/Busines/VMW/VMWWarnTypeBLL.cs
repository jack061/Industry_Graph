...
{	
	...
	/// VMWWarnTypeBLL
	/// </summary>	
	public class VMWWarnTypeBLL
	{
	    private IVMWWarnTypeRepository service=new VMWWarnTypeRepository();

		/// <summary>
        /// 缓存key
        /// </summary>
        public string cacheKey ="VMWWarnTypeCache" ;
        ...
        /// <returns></returns>
        public IEnumerable<VMWWarnTypeEntity> GetPageListBySql(Pagination pagination, string queryJson)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public IEnumerable<VMWWarnTypeEntity> GetList( string queryJson)
        {
             var expression = LinqExtensions.True<VMWWarnTypeEntity>();
            var queryParam = queryJson.ToJObject();
            //查询条件
        ...
        /// <param name="queryJson">查询参数</param>
        /// <returns></returns>
        public IEnumerable<VMWWarnTypeEntity> GetPageList(Pagination pagination, string queryJson)
        {
			var expression = LinqExtensions.True<VMWWarnTypeEntity>();
            var queryParam = queryJson.ToJObject();
             //查询条件
        ...
        public void SaveForm(string keyValue, VMWWarnTypeEntity vMWWarnTypeEntity)
        {
            try
            {
                service.SaveForm(keyValue, vMWWarnTypeEntity);
                CacheFactory.Cache().WriteCache(cacheKey,vMWWarnTypeEntity);
            }
            catch (Exception)
            {
                throw;
