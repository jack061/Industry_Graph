...
{	
	...
	/// IOTMouldPParaBLL
	/// </summary>	
	public class IOTMouldPParaBLL
	{
	    private IIOTMouldPParaRepository service=new IOTMouldPParaRepository();

		/// <summary>
        /// 缓存key
        /// </summary>
        public string cacheKey ="IOTMouldPParaCache" ;
        ...
        /// <returns></returns>
        public IEnumerable<IOTMouldPParaEntity> GetPageListBySql(Pagination pagination, string queryJson)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public IEnumerable<IOTMouldPParaEntity> GetList( string queryJson)
        {
             var expression = LinqExtensions.True<IOTMouldPParaEntity>();
            var queryParam = queryJson.ToJObject();
            //查询条件
        ...
        /// <param name="queryJson">查询参数</param>
        /// <returns></returns>
        public IEnumerable<IOTMouldPParaEntity> GetPageList(Pagination pagination, string queryJson, string bindid)
        {
			var expression = LinqExtensions.True<IOTMouldPParaEntity>();
            var queryParam = queryJson.ToJObject();
             //查询条件
        ...
        public void SaveForm(string keyValue, IOTMouldPParaEntity iOTMouldPParaEntity)
        {
            try
            {
                service.SaveForm(keyValue, iOTMouldPParaEntity);
                CacheFactory.Cache().WriteCache(cacheKey,iOTMouldPParaEntity);
            }
            catch (Exception)
            {
                throw;
