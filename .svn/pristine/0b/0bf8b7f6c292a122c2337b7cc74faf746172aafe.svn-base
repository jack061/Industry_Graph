...
{	
	...
	{
	    private IIOTProductRepository service=new IOTProductRepository();

		/// <summary>
        /// 缓存key
        /// </summary>
        public string cacheKey ="IOTProductCache" ;
        ...
        /// <returns></returns>
        public IEnumerable<IOTProductEntity> GetPageListBySql(Pagination pagination, string queryJson)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public IEnumerable<IOTProductEntity> GetList( string queryJson)
        {
             var expression = LinqExtensions.True<IOTProductEntity>();
            var queryParam = queryJson.ToJObject();
            //查询条件
        ...
        /// <param name="queryJson">查询参数</param>
        /// <returns></returns>
        public IEnumerable<IOTProductEntity> GetPageList(Pagination pagination, string queryJson)
        {
			var expression = LinqExtensions.True<IOTProductEntity>();
            var queryParam = queryJson.ToJObject();
             //查询条件
        ...
        public void SaveForm(string keyValue, IOTProductEntity iOTProductEntity)
        {
            try
            {
                service.SaveForm(keyValue, iOTProductEntity);
                CacheFactory.Cache().WriteCache(cacheKey,iOTProductEntity);
            }
            catch (Exception)
            {
                throw;
