...
{	
	...
	/// IOTMouldBLL
	/// </summary>	
	public class IOTMouldBLL
	{
	    private IIOTMouldRepository service=new IOTMouldRepository();

		/// <summary>
        /// 缓存key
        /// </summary>
        public string cacheKey ="IOTMouldCache" ;
        ...
        /// <returns></returns>
        public IEnumerable<IOTMouldEntity> GetPageListBySql(Pagination pagination, string queryJson)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public IEnumerable<IOTMouldEntity> GetList( string queryJson)
        {
             var expression = LinqExtensions.True<IOTMouldEntity>();
            var queryParam = queryJson.ToJObject();
            //查询条件
        ...
        /// <param name="queryJson">查询参数</param>
        /// <returns></returns>
        public IEnumerable<IOTMouldEntity> GetPageList(Pagination pagination, string queryJson)
        {
			var expression = LinqExtensions.True<IOTMouldEntity>();
            var queryParam = queryJson.ToJObject();
             //查询条件
        ...
        public void SaveForm(string keyValue, IOTMouldEntity iOTMouldEntity)
        {
            try
            {
                service.SaveForm(keyValue, iOTMouldEntity);
                CacheFactory.Cache().WriteCache(cacheKey,iOTMouldEntity);
            }
            catch (Exception)
            {
                throw;
